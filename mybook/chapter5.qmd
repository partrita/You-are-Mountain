...
있는 그대로의 모습으로 나타나기 시작할 때 인생이 바뀝니다. 앞으로 나아가고 싶더라도 지금 여기에서 행복해지는 것에 익숙해질 때 인생이 바뀝니다. 원하는 모습과 똑같지 않아도 자신을 사랑할 수 있을 때 인생이 바뀝니다. 돈과 사랑과 관계에 대해 원칙이 있을 때, 낯선 사람을

CEO만큼 대우할 때, 그리고 1,000달러를 10,000달러처럼 관리할 때 인생이 바뀝니다.
...
있는 그대로 기분이 좋지 않은지 스스로에게 설명하기 위한 게임이었습니다. 어떻게 당신을 드러내고 감정을 허용하는지 알기 전까지 말이죠. 어둠 속에 살았을 때, 당신은 그것을 억누르고 다른 문제들에 투사해야 했습니다. 더 이상은 아닙니다.
...
이것이 노출이 두려움이나 불안에 대한 치료로서 그토록 효과적인 이유입니다. 스트레스 요인을 점진적으로 누군가의 삶에 다시 도입함으로써—그리고 그들이 그것을 감당할 수 있음을 보여줌으로써—

통제감과 보안감이 다시 확립되기 때문에 뇌는 중립 상태로 돌아갈 수 있습니다.
...
신경학적으로, 우리는 스트레스를 뇌의 세 부분에서 처리합니다.13

첫 번째는 편도체, 두 번째는 해마, 세 번째는 전두엽 피질입니다. 외상 후 스트레스 장애(PTSD)를 앓고 있는 개인은 더 작은 해마(감정과 기억의 중심), 증가된 편도체 기능(반추와 창의성의 중심), 그리고 감소된 내측 전두엽/전대상 피질 기능(계획 및 자기 개발과 같은 복잡한 행동을 관장하는 중심)을 가지고 있습니다.
...
하지만, 이 회복의 가장 중요한 부분은

당신을 트라우마에 빠뜨린 바로 그 삶의 영역에서 안전함을 다시 확립해야 한다는 것입니다.
